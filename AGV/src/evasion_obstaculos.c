/*
 * Implementamos la ecuacion cinematica de un robot diferencial, esta fue validada en matlab
 * consideramos varios factores, como velocidad deseada, radio de la rueda, y distancias entre las mismas
 * Activamos el movimiento con un puente h, en los pines (1<<14)+(1<<7), utilizamos
 * LPIT0 Ch0 para motor derecho y LPIT0 Ch1 para motor izquierdo
 */
