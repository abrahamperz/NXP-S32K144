		...
		if (IIC_ack_input()==0)
			{
				...
				if (IIC_ack_input()==0)
					{
						//movimiento
					datos_recibidosI2C[0] = IIC_rec_byte();
					    //tiempo
					datos_recibidosI2C[1] = IIC_rec_byte();
					    //movimiento
					datos_recibidosI2C[2] = IIC_rec_byte();
					    //tiempo
					datos_recibidosI2C[3] = IIC_rec_byte();
					    //movimiento
					datos_recibidosI2C[4] = IIC_rec_byte();
					    //tiempo
					datos_recibidosI2C[5] = IIC_rec_byte();
					    //movimiento
				    datos_recibidosI2C[6] = IIC_rec_byte();
					    //tiempo
					datos_recibidosI2C[7] = IIC_rec_byte();
